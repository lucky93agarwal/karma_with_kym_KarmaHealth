...
public class AfternoonMedicenAdapter extends RecyclerView.Adapter<AfternoonMedicenAdapter.ViewHolder> {
    ...
    public AfternoonMedicenAdapter(List<MedicenListModel> productList, Context context) {
        super();
        mcontext = context;
    ...
    @NonNull
    @Override
    public AfternoonMedicenAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AfternoonMedicenAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvNoofTablet;
        public TextView tvTime,tvWhen, tvButtonViewOption;
