...
public class MedicenAdapter extends RecyclerView.Adapter<MedicenAdapter.ViewHolder> {
    ...
    public MedicenAdapter(List<MedicenListModel> productList, Context context) {
        super();
        mcontext = context;
    ...
    @NonNull
    @Override
    public MedicenAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MedicenAdapter.ViewHolder holder, int position) {
    ...
    public void onDelete(String id){
       // Toast.makeText(mcontext, "id = "+id+" user id = "+sharedPreferences.getString("kymPid", "134388"), Toast.LENGTH_SHORT).show();
        ...
        service.deleteDrugAPI(sharedPreferences.getString("kymPid", "134388"),String.valueOf(id),"MD",token).enqueue(new Callback<APIMessageResponse>() {
            @Override
