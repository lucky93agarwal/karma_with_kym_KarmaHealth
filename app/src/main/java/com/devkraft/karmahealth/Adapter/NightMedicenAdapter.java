...
public class NightMedicenAdapter extends RecyclerView.Adapter<NightMedicenAdapter.ViewHolder> {
    ...
    public NightMedicenAdapter(List<MedicenListModel> productList, Context context) {
        super();
        mcontext = context;
    ...
    @NonNull
    @Override
    public NightMedicenAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NightMedicenAdapter.ViewHolder holder, int position) {
    ...
    public void onDelete(String id){
        ...
        UserService service = ServiceGeneratorTwo.createService(UserService.class, null, null, false);
        service.deleteDrugAPI(sharedPreferences.getString("kymPid", "134388"),String.valueOf(id),"ND",token).enqueue(new Callback<APIMessageResponse>() {
            @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvNoofTablet,tvWhen, tvButtonViewOption;
