...
public class GenericRequest<T> extends JsonRequest<T> {
    ...
    public static final int MAX_ALLOWED_AFTER_REFRESH_ATTEMPTS = 0;
    ...
    private GenericRequest(int method, Class<T> classtype, String url, String requestBody,
        ...
        if(ApplicationPreferences.get().getUserDetails() != null){
            headers.put("Authorization","Bearer " + ApplicationPreferences.get().getUserDetails().getAccessToken());
        }
    ...
    public void setHeader() {
        if(ApplicationPreferences.get().getUserDetails() != null){
            this.headers.put("Authorization","Bearer " + ApplicationPreferences.get().getUserDetails().getAccessToken());
        }
    }
    ...
    public static Map<String, String> getDefHeaders() {
        ...
        tempHeaders.put("Accept", "application/json");
        return tempHeaders;
    }
